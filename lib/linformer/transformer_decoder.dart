...
class TransformerDecoder extends Module {
  ...
  final int? projK; // NEW: Add projK to the class fields
  ...
  final Layer valueHead; // Value head to predict the game outcome
  ...
  TransformerDecoder({
    ...
    this.projK = 128, // NEW: Add projK parameter with a default value
        ...
        // CORRECTED: Pass the projK parameter to the TransformerDecoderBlock constructor
        blocks = List.generate(
            numLayers,
            (i) => TransformerDecoderBlock(
                embedSize, numHeads, encoderEmbedSize,
                projK: projK)),
