...
class TransformerDecoderBlock extends Module {
  ...
  //       ln3 = LayerNorm(embedSize); // Renamed
        ...
        // Add projK as an optional named parameter
  TransformerDecoderBlock(this.embedSize, int numHeads, int encoderEmbedSize, {int? projK})
      // Pass projK to the self-attention layer
      : selfAttention = MultiHeadAttention(numHeads, embedSize, masked: true, projK: projK),
        // Pass projK to the cross-attention layer
        crossAttention = MultiHeadCrossAttention(numHeads, embedSize, encoderEmbedSize, projK: projK),
        ffn = FeedForward(embedSize),
        ln1 = LayerNorm(embedSize),
